...
function Form() {
  ...
  <div className={'output'}>
    ...
    <button type={'button'}
            ...
            onClick={() => navigator.clipboard.writeText(outlookText)}> Outlook
    </button>

    <button type={'button'}
            className={'btn btn-primary m-1'}
            onClick={() => navigator.clipboard.writeText(yahooText)}> Yahoo
    </button>


    <button type={'button'}
            className={'btn btn-primary m-1'}
            onClick={() => navigator.clipboard.writeText(googleText)}> Google
    </button>
